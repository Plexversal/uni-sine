        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img src="/static/maths/logs/image001.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image002.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image003.png" className={styles['equation']}></img>

                    <p><strong>Subtracting logs:</strong></p>
                    <img src="/static/maths/logs/image004.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image005.png" className={styles['equation']}></img>

                    <p><strong>Logs raised to powers:</strong></p>
                    <img src="/static/maths/logs/image006.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image007.png" className={styles['equation']}></img>

                    <p><strong>Same base logs:</strong></p>
                    <img src="/static/maths/logs/image008.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image009.png" className={styles['equation']}></img>

                    <p><strong>Log of 1:</strong></p>
                    <img src="/static/maths/logs/image010.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image011.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image012.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image013.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image014.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image015.png" className={styles['equation']}></img>

                    <h3>Example (advanced)</h3>
                    <ul>
                        <li>Solve the below equation for variable x, where x &gt; 1:</li>
                    </ul>
                    <img src="/static/maths/logs/image016.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image017.png" className={styles['equation']}></img>

                    <p>The logs cancel by using 8 raised to the power of both sides leaving the following quadratic:</p>
                    <img src="/static/maths/logs/image018.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image019.png" className={styles['equation']}></img>

                    <p>Simplifying the quadratic:</p>
                    <img src="/static/maths/logs/image020.png" className={styles['equation']}></img>

                    <p>Using quadratic formula to get the values of x:</p>
                    <img src="/static/maths/logs/image021.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image022.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image023.png" className={styles['equation']}></img>
                    ...
                    <p>Natural logs being just the normal logs with a base of Euler's number but rewritten in natural log form:</p>
                    <img src="/static/maths/logs/image024.png" className={styles['equation']}></img>

                    <p>The natural log and e are inverses of each other so the following statements would cancel and give you x on its own:</p>
                    <img src="/static/maths/logs/image025.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image026.png" className={styles['equation']}></img>

                    <p>Natural logs can be used in the same way as logs to work out exponential equations:</p>
                    <img src="/static/maths/logs/image027.png" className={styles['equation']}></img>

                    <p>This is derived using the normal log laws:</p>
                    <img src="/static/maths/logs/image028.png" className={styles['equation']}></img>

                    <p>Take natural log of both sides:</p>
                    <img src="/static/maths/logs/image029.png" className={styles['equation']}></img>

                    <p>Using exponential log laws, the x can be brought to the front:</p>
                    <img src="/static/maths/logs/image030.png" className={styles['equation']}></img>

                    <p>Dividing both sides by the natural log of a gives x:</p>
                    <img src="/static/maths/logs/image031.png" className={styles['equation']}></img>

                    <h3>Example (simple)</h3>
                    <ol>
                        <li>Solve the below equation for variable x to 3 significant figures:</li>
                    </ol>
                    <img src="/static/maths/logs/image032.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image033.png" className={styles['equation']}></img>

                    <p>Then rearrange for x:</p>
                    <img src="/static/maths/logs/image034.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image035.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image036.png" className={styles['equation']}></img>

                    <h3>Example (Advanced)</h3>
                    <ol>
                        <li>Solve the below equation for variable x to 3 significant figures:</li>
                    </ol>
                    <img src="/static/maths/logs/image037.png" className={styles['equation']}></img>

                    <p>Answer:</p>
                    <p>First step is to take the natural logarithm of both sides in order to get x out of exponent:</p>
                    <img src="/static/maths/logs/image038.png" className={styles['equation']}></img>

                    <p>Expand the right side:</p>
                    <img src="/static/maths/logs/image039.png" className={styles['equation']}></img>

                    <p>Get all variables to one side:</p>
                    <img src="/static/maths/logs/image040.png" className={styles['equation']}></img>

                    <p>Factorise the left side:</p>
                    <img src="/static/maths/logs/image041.png" className={styles['equation']}></img>

                    <p>Solve for x:</p>
                    <img src="/static/maths/logs/image042.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image043.png" className={styles['equation']}></img>
