        ...
        <>
            ...
            <article id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <P5Graph  {...{showControls: false, showFunction: false, showIntercepts: false, a: 0, b: 5, c: -3}}/>
                    ...
                    <img src="/static/maths/linear-equations/image001.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/linear-equations/image002.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/linear-equations/image003.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/linear-equations/image004.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/linear-equations/image005.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image006.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/linear-equations/image007.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image008.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image009.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image010.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/linear-equations/image011.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image012.png" className={styles['equation']}></img>
                    <div >
                        <ol start={3}>
                    ...
                    <img src="/static/maths/linear-equations/image013.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image014.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image015.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image016.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image017.png" className={styles['equation']}></img>
                    <img src="/static/maths/linear-equations/image018.png" className={styles['equation']}></img>
