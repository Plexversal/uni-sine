...
import P5Trig from  '../../components/P5TrigTriangle'
        ...
        <>
            ...
            <article id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img src="/static/maths/trig/image001.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image002.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image003.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image004.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image005.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image006.png" className={styles['equation']}></img>
                    <p>Another rule for working with right angled triangles is the Pythagorean theorem:</p>
                    <img src="/static/maths/trig/image007.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image008.png" className={styles['equation']}></img>
                    <p>Using the inverse of the sin function we can get the value of theta:</p>
                    <img src="/static/maths/trig/image009.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image010.png" className={styles['equation']}></img>
                    <ol start={2}>
                    ...
                    <img src="/static/maths/trig/image011.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image012.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image013.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image014.png" className={styles['equation']}></img>
                    <ol start={3}>
                    ...
                    <img src="/static/maths/trig/image015.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image016.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image017.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image018.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image019.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image020.png" className={styles['equation']}></img>
                    <p>So, if b is the length and also the x value, we can equate the following:</p>
                    <img src="/static/maths/trig/image021.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image022.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image023.png" className={styles['equation']}></img>
                    <p>So, if a is the length and also the y value, we can equate the following:</p>
                    <img src="/static/maths/trig/image024.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image025.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image026.png" className={styles['equation']}></img>
                    <p>With this we can also work out other angles such as half a circle:</p>
                    <img src="/static/maths/trig/image027.png" className={styles['equation']}></img>
                    ...
                    <h2>Sine rule</h2>
                    <img src="/static/maths/trig/image028.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image001.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image030.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image031.png" className={styles['equation']}></img>

                    <p>So, we can solve for h using all these variables:</p>
                    <img src="/static/maths/trig/image032.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image033.png" className={styles['equation']}></img>

                    <p>Therefore:</p>
                    <img src="/static/maths/trig/image034.png" className={styles['equation']}></img>

                    <p>We can then rearrange the equation for opposite sides and angles being together:</p>
                    <img src="/static/maths/trig/image035.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image036.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image001edit (1).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (2).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (3).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (4).png" className={styles['equation']}></img>
                    <ol start="2">
                    ...
                    <img src="/static/maths/trig/image001edit (5).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (6).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (7).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (8).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (9).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (10).png" className={styles['equation']}></img>


                    <h2>Cosine rule</h2>
                    <img src="/static/maths/trig/image046.png" className={styles['equation']}></img>
                    <p>Rewriting this equation can give you the angle:</p>
                    <img src="/static/maths/trig/image047.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image048.png" className={styles['equation']}></img>

                    <p>If we take substitute into Pythagoras&rsquo; theorem, we can find side h:</p>
                    <img src="/static/maths/trig/image049.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image050.png" className={styles['equation']}></img>

                    <p>We can also find side b using the same method:</p>
                    <img src="/static/maths/trig/image051.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image052.png" className={styles['equation']}></img>
                    <p>Thus:</p>
                    <img src="/static/maths/trig/image053.png" className={styles['equation']}></img>

                    <p>Expanding the brackets gives:</p>
                    <img src="/static/maths/trig/image054.png" className={styles['equation']}></img>

                    <p>Simplifying:</p>
                    <img src="/static/maths/trig/image055.png" className={styles['equation']}></img>

                    <p>Now we can find a1 in terms of angles and sides using the relevant trigonometric equation:</p>
                    <img src="/static/maths/trig/image002.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image056.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image057.png" className={styles['equation']}></img>
                    <p>Substituting backing to the equation:</p>
                    <img src="/static/maths/trig/image058.png" className={styles['equation']}></img>
                    <p>This can be rearranged to solve for a different angle:</p>
                    <img src="/static/maths/trig/image059.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image001edit (11).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (12).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (13).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (14).png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image001edit (15).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (16).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (17).png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image001edit (18).png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image066.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image067.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image068.png" className={styles['equation']}></img>

                    <p><strong>Ratios:</strong></p>
                    <img src="/static/maths/trig/image069.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image070.png" className={styles['equation']}></img>

                    <p><strong>Compliments: </strong></p>
                    <img src="/static/maths/trig/image071.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image072.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image073.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image074.png" className={styles['equation']}></img>

                    <p><strong>Pythagorean identity</strong></p>
                    <p>Given the equation for a circle is the following:</p>
                    <img src="/static/maths/trig/image075.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image076.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image077.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image078.png" className={styles['equation']}></img>

                    <p>If we divide through by cos theta we get:</p>
                    <img src="/static/maths/trig/image079.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image080.png" className={styles['equation']}></img>

                    <p>If we divide through by sin theta we get:</p>
                    <img src="/static/maths/trig/image081.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image082.png" className={styles['equation']}></img>

                    <p><strong>Compound angle identities:</strong></p>
                    <img src="/static/maths/trig/image083.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image084.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image085.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image086.png" className={styles['equation']}></img>
                    <p>Simplified using compliments:</p>
                    <img src="/static/maths/trig/image087.png" className={styles['equation']}></img>
                    <p>The signs can be switch to give the following:</p>
                    <img src="/static/maths/trig/image088.png" className={styles['equation']}></img>
                    <p>For tan, given we have an identity that links sine and cosine with tan we can rewrite the formula in these terms:</p>
                    <img src="/static/maths/trig/image089.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image090.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image091.png" className={styles['equation']}></img>

                    <p>Using the tan ratio identity, it provides the following:</p>
                    <img src="/static/maths/trig/image092.png" className={styles['equation']}></img>

                    <p>You can inverse the signs for the following:</p>
                    <img src="/static/maths/trig/image093.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image094.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image095.png" className={styles['equation']}></img>

                    <p>For cosine, there are multiple that can be derived using multiple identity rules:</p>
                    <img src="/static/maths/trig/image096.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image097.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig/image098.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image099.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image100.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image101.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image102.png" className={styles['equation']}></img>

                    <p>For tangent double angle identity:</p>
                    <img src="/static/maths/trig/image103.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig/image104.png" className={styles['equation']}></img>
