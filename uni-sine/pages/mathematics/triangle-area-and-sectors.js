        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img src="/static/maths/trig2/image001.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image002.png" className={styles['equation']}></img>
                    ...
                    <p>So,</p>
                    <img src="/static/maths/trig2/image003.png" className={styles['equation']}></img>
                    <p>Substituting the base of each triangle into the original formula for the area of a triangle we get the following:</p>
                    <img src="/static/maths/trig2/image004.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image005.png" className={styles['equation']}></img>
                    <p>Hence,</p>
                    <img src="/static/maths/trig2/image006.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image007.png" className={styles['equation']}></img>
                    <p>Expand the brackets:</p>
                    <img src="/static/maths/trig2/image008.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image009.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image010.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image011.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image012.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image013.png" className={styles['equation']}></img>
                    <p>Square root every term for h:</p>
                    <img src="/static/maths/trig2/image014.png" className={styles['equation']}></img>
                    <p>This can now be substituted back into the original formula:</p>
                    <img src="/static/maths/trig2/image015.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image009.png" className={styles['equation']}></img>
                    <h3>Area of any triangle with an angle between 2 given sides:</h3>
                    <p><em>Insert area picture </em></p>
                    <img src="/static/maths/trig2/image016.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image017.png" className={styles['equation']}></img>
                    <p>Solving for h:</p>
                    <img src="/static/maths/trig2/image018.png" className={styles['equation']}></img>
                    <p>Substituting this into the original formula we get:</p>
                    <img src="/static/maths/trig2/image019.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image020.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image021.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image022.png" className={styles['equation']}></img>
                    <p>Using the Pythagorean theorem, we can express sides a and b with terms of h:</p>
                    <img src="/static/maths/trig2/image023.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image024.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image025.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image026.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image027.png" className={styles['equation']}></img>
                    <p>We can now divide through by b:</p>
                    <img src="/static/maths/trig2/image028.png" className={styles['equation']}></img>
                    <p>If:</p>
                    <img src="/static/maths/trig2/image022.png" className={styles['equation']}></img>
                    <p>We can add the equations so solve for b<sub>2</sub>:</p>
                    <img src="/static/maths/trig2/image030.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image031.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image032.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image033.png" className={styles['equation']}></img>
                    <p>Substituting b2 into this equation provides h in terms of all the sides which is what we needed:</p>
                    <img src="/static/maths/trig2/image034.png" className={styles['equation']}></img>
                    <p>We can now substitute this back into the original area formula:</p>
                    <img src="/static/maths/trig2/image035.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image036.png" className={styles['equation']}></img>
                    <p>We can now put everything in one square root and use the difference of 2 squares:</p>
                    <img src="/static/maths/trig2/image037.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image038.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image039.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image040.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image041.png" className={styles['equation']}></img>
                    <p>As there are 4 terms within the square root, we can divide the 1/16 through equally:</p>
                    <img src="/static/maths/trig2/image042.png" className={styles['equation']}></img>
                    <p>If we take the semi-perimeter to be S:</p>
                    <img src="/static/maths/trig2/image043.png" className={styles['equation']}></img>
                    <p>Then we can use that for the first term:</p>
                    <img src="/static/maths/trig2/image044.png" className={styles['equation']}></img>
                    <p>If we take the first term:</p>
                    <img src="/static/maths/trig2/image045.png" className={styles['equation']}></img>
                    <p>This is equal to the following:</p>
                    <img src="/static/maths/trig2/image046.png" className={styles['equation']}></img>
                    <p>Hence:</p>
                    <img src="/static/maths/trig2/image047.png" className={styles['equation']}></img>
                    <p>The remaining terms are same but for the different sides and we can rearrange for the original formula:</p>
                    <img src="/static/maths/trig2/image048.png" className={styles['equation']}></img>


                    <h2>Sector, segments and arcs of a circle</h2>
                    <h3>Arc length</h3>
                    <p><em>Insert arc length picture</em></p>
                    <img src="/static/maths/trig2/image049.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image050.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image051.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image052.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image053.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image054.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image055.png" className={styles['equation']}></img>
                    <h3>Sector area</h3>
                    <p><em>Insert sector picture</em></p>
                    <img src="/static/maths/trig2/image056.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image057.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image058.png" className={styles['equation']}></img>
                    <p>So:</p>
                    <img src="/static/maths/trig2/image059.png" className={styles['equation']}></img>
                    <p>This can cancel to the original formula:</p>
                    <img src="/static/maths/trig2/image060.png" className={styles['equation']}></img>
                    <h4>Example</h4>
                    ...
                    <img src="/static/maths/trig2/image061.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image062.png" className={styles['equation']}></img>
                    <h3>Segment area</h3>
                    <p><em>Insert segment picture</em></p>
                    <img src="/static/maths/trig2/image063.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image064.png" className={styles['equation']}></img>
                    <p>And the triangle area to be:</p>
                    <img src="/static/maths/trig2/image065.png" className={styles['equation']}></img>
                    <p>The difference between them provides the segment area:</p>
                    <img src="/static/maths/trig2/image066.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image067.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/trig2/image068.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image069.png" className={styles['equation']}></img>
                    <img src="/static/maths/trig2/image070.png" className={styles['equation']}></img>
                </div>
            </article>
        </>
    )
