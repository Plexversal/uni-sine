        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img alt=''src="/static/maths/vectors/image001.png" className={styles['equation']}></img>

                    <p>Vectors are often written in boldface, underlined or with an arrow above the symbol.</p>
                    <img alt=''src="/static/maths/vectors/image002.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image003.png" className={styles['equation']}></img>

                    <p>A 3D column vector is a matrix consisting of a single column of numbers, with three elements. For example, the matrix:</p>
                    <img alt=''src="/static/maths/vectors/image004.png" className={styles['equation']}></img>
                    ...
                    <p>For example:</p>
                    <img alt=''src="/static/maths/vectors/image005.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image006.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image007.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image008.png" className={styles['equation']}></img>                    <img alt=''src="/static/maths/vectors/image009.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image010.png" className={styles['equation']}></img>
                    <p>The opposite side is the difference in y values and the adjacent side is the difference in x values:</p>
                    <img alt=''src="/static/maths/vectors/image011.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image012.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image013.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image014.png" className={styles['equation']}></img>
                    <p>The y component can be calculated using the following:</p>
                    <img alt=''src="/static/maths/vectors/image015.png" className={styles['equation']}></img>                    <img alt=''src="/static/maths/vectors/image016.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image017.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image018.png" className={styles['equation']}></img>
                    <p><em>Answer:</em></p>
                    ...
                    <img alt=''src="/static/maths/vectors/image019.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image020.png" className={styles['equation']}></img>
                    <p>To answer the question on direction, it may be easier to draw a diagram first:</p>
                    <img alt=''src="/static/maths/vectors/image021.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image022.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image023.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image024.png" className={styles['equation']}></img>
                    <p>Subtract this from 180:</p>
                    <img alt=''src="/static/maths/vectors/image025.png" className={styles['equation']}></img>
                    <p>Written in final form, the vector is:</p>
                    <img alt=''src="/static/maths/vectors/image026.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image027.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image028.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image029.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image030.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image031.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image032.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image033.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image034.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image035.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image036.png" className={styles['equation']}></img>
                    <p>The angle needs to be converted to degrees from radians:</p>
                    <img alt=''src="/static/maths/vectors/image037.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image038.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image039.png" className={styles['equation']}></img>
                    <p>Calculate the connecting vector and its magnitude:</p>
                    <img alt=''src="/static/maths/vectors/image040.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image041.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image042.png" className={styles['equation']}></img>
                    <p>Now we can substitute into cosine formula:</p>
                    <img alt=''src="/static/maths/vectors/image043.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image044.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image045.png" className={styles['equation']}></img>

                    <p>To convert this to degrees, multiply by 180/pi:</p>
                    <img alt=''src="/static/maths/vectors/image046.png" className={styles['equation']}></img>
                    <h2>3D Vectors</h2>
                    ...
                    <img alt=''src="/static/maths/vectors/image047.png" className={styles['equation']}></img>
                    <p>The letter used for the z value in component form is k, so the vector in component form is:</p>
                    <img alt=''src="/static/maths/vectors/image048.png" className={styles['equation']}></img>
                    ...
                    <br></br>
                    <img alt=''src="/static/maths/vectors/image049.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/vectors/image050.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image051.png" className={styles['equation']}></img>
                    <p><em>Answer:</em></p>
                    ...
                    <img alt=''src="/static/maths/vectors/image052.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image053.png" className={styles['equation']}></img>
                    <p>The magnitude of each vector can be calculated using the Pythagorean formula:</p>
                    <img alt=''src="/static/maths/vectors/image054.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image055.png" className={styles['equation']}></img>
                    <p><br />We can now substitute into the dot product formula for finding the angle:</p>
                    <img alt=''src="/static/maths/vectors/image056.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image057.png" className={styles['equation']}></img>
                    <p>Solve for theta and convert to degrees:</p>
                    <img alt=''src="/static/maths/vectors/image058.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/vectors/image059.png" className={styles['equation']}></img>
                    <p></p>
