        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img alt=''src="/static/maths/exponents/image001.png" className={styles['equation']}></img>
                    <p>E.g.</p>
                    <img alt=''src="/static/maths/exponents/image002.png" className={styles['equation']}></img>
                    <p>Second rule for dividing indices:</p>
                    <p>Subtract the powers when dividing with the same base number</p>
                    <img alt=''src="/static/maths/exponents/image003.png" className={styles['equation']}></img>
                    <p>E.g.</p>
                    <img alt=''src="/static/maths/exponents/image004.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/exponents/image005.png" className={styles['equation']}></img>
                    <p>E.g.</p>
                    <img alt=''src="/static/maths/exponents/image006.png" className={styles['equation']}></img>
                    <p>Forth rule for any number raised to power of zero:</p>
                    <p>Any base number raised to the power of 0 always equals 1</p>
                    <img alt=''src="/static/maths/exponents/image007.png" className={styles['equation']}></img>
                    <p>E.g.</p>
                    <img alt=''src="/static/maths/exponents/image008.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/exponents/image009.png" className={styles['equation']}></img>
                    <p>E.g.</p>
                    <img alt=''src="/static/maths/exponents/image010.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/exponents/image011.png" className={styles['equation']}></img>
                    <p>E.g.</p>
                    <img alt=''src="/static/maths/exponents/image012.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/exponents/image013.png" className={styles['equation']}></img>
                    <p>E.g.</p>
                    <img alt=''src="/static/maths/exponents/image014.png" className={styles['equation']}></img>
                </div>
