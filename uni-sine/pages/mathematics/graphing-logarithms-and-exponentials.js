            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <tbody>
                        ...
                        <img src="/static/maths/logs/image044.png" className={styles['equation']}></img>
                    ...
                    <tr>
                        <td width="200" valign="top">
                        <img src="/static/maths/logs/image045.png" className={styles['equation']}></img>


                        </td>
                        <td width="200" valign="top">
                        <img src="/static/maths/logs/image046.png" className={styles['equation']}></img>

                        </td>
                        <td width="200" valign="top">  
                        <img src="/static/maths/logs/image047.png" className={styles['equation']}></img>

                        </td>
                        <td width="200" valign="top">  
                        <img src="/static/maths/logs/image048.png" className={styles['equation']}></img>

                        </td>
                        <td width="200" valign="top">  
                        <img src="/static/maths/logs/image049.png" className={styles['equation']}></img>

                        </td>
                        <td width="200" valign="top">  
                        <img src="/static/maths/logs/image050.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image051.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image052.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image053.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image054.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image055.png" className={styles['equation']}></img>
                    ...
                    <tr>
                        ...
                        <td width="200" valign="top">
                        <img src="/static/maths/logs/image056.png" className={styles['equation']}></img>

                        </td>
                        <td width="200" valign="top">  
                        <img src="/static/maths/logs/image057.png" className={styles['equation']}></img>

                        </td>
                        <td width="200" valign="top">  
                        <img src="/static/maths/logs/image058.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/maths/logs/image059.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image060.png" className={styles['equation']}></img>

                    <p>Next find the x-intercept:</p>
                    <img src="/static/maths/logs/image061.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image062.png" className={styles['equation']}></img>

                    <p>Using ln = log base e:</p>
                    <img src="/static/maths/logs/image063.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image064.png" className={styles['equation']}></img>
                    <img src="/static/maths/logs/image065.png" className={styles['equation']}></img>
