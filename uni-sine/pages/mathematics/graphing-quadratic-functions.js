        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image002.png" className={styles['equation']}></img>
                    ...
                    <h2 >Real roots</h2>
                    <img alt=''src="/static/maths/quadratic-equations/image003.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image004.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image005.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image006.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image007.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image008.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image007.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image009.png" className={styles['equation']}></img>
                    <p >The minimum for y part of the coordinate is as follows:</p>
                    <img alt=''src="/static/maths/quadratic-equations/image010.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image011.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image012.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image013.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image014.png" className={styles['equation']}></img>

                    <p >So, the coordinate for the minimum value of this quadratic is:</p>
                    <img alt=''src="/static/maths/quadratic-equations/image015.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image002.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image016.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image017.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image018.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image019.png" className={styles['equation']}></img>

                    <p >We have simplified enough here to determine a value for both the plus and minus sign:</p>
                    <img alt=''src="/static/maths/quadratic-equations/image020.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image021.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image022.png" className={styles['equation']}></img>

                    <p >Now for the minus:</p>
                    <img alt=''src="/static/maths/quadratic-equations/image023.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image024.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image025.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image027.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image028.png" className={styles['equation']}></img>

                    <p >Now for x=5:</p>
                    <img alt=''src="/static/maths/quadratic-equations/image029.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image030.png" className={styles['equation']}></img>
                    <img alt=''src="/static/maths/quadratic-equations/image031.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/maths/quadratic-equations/image032.png" className={styles['equation']}></img>

                    <p >In total we can plot the following points:</p>
                    <img alt=''src="/static/maths/quadratic-equations/image033.png" className={styles['equation']}></img>
