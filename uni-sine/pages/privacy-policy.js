    ...
    return (
        <div className={`${styles['container']} ${styles['privacy-container']}`}>
            ...
            <article>
                    ...
                    <p>This privacy policy sets out how Uni-Sine uses and protects any information that you give Uni-Sine when you use this website.</p>
                    <p>Uni-Sine is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.</p>
                    <p>Uni-Sine may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.</p>
