      ...
      <div className={styles['activity']}>
        <div className={styles['info-panel']}>
          <div className={styles['task-info']}>
              <i><h1>Problem 2</h1></i>
              <h3>Create a function to calculate the area of a triangle.</h3>
              <p>You are tasked to create a function that takes two parameters that then use the formula for the area of a triangle</p>
              <ul>
                  <li>Only one function can be used with only one expected output.</li>
                  <li>Function must take exactly <strong>two</strong> parameters: base and height.</li>
                  <li>Output should be of data type: <code>Number</code>.</li>
                  <li>Output should be be correct calculation for triangle area.</li>
          ...
          <div className={styles['example-code']}>
              ...
              <CodeBlock language="javascript" code={`// input \nbase = 5\nheight = 9\n\n// result:\n22.5`} showCopy={false}/>
