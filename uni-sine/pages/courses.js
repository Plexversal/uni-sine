...
export default function Courses({ user }) {
  ...
  const modalMap = {
    "Web development": {
      component: (
        <CoursesModal
          {...{ onClose: handleCloseModal, courseName: "Web Development" }}
        />
      ),
      description:
        "More than just the fundamentals of web development... Learn how to think like a web developer.",
      isFree: false,
      isPopular: true,
      ...
      longDescription:
        "Learn the fundamentals of web development and explore how web developers use a variety of tools and applications to make web development easier.",
    },
    Trigonometry: {
      component: (
        <CoursesModal
          {...{ onClose: handleCloseModal, courseName: "Trigonometry" }}
        />
      ),
      description:
        "Get the basics of trigonometry to understand the true math behind everyday geometry",
      isFree: false,
      isPopular: false,
      icon: <LuTriangleRight size={50} />,
      list: [
        "Basic Trigonometric Functions",
        "Basic Trigonometric Functions Practice",
        "Further Trigonometric Functions",
        "Further Trigonometric Functions Practice",
        "Unit Circle",
      ...
      longDescription:
        "Understand the main aspects of trigonometry and how its used in everyday scenarios, explore how to use basic and advanced trigonometric functions.",
    },
    "Black Hole Formation": {
      component: (
        <CoursesModal
          {...{ onClose: handleCloseModal, courseName: "Black Hole Formation" }}
        />
      ),
      description:
        "The most mysterious objects in the universe... brought closer to earth with science.",
      isFree: false,
      isPopular: false,
      ...
      longDescription:
        "Learn cutting edge research with how black holes are created from super massive stars and understand famous Einstein equations.",
    },
    "Nuclear Energy": {
      component: (
        <CoursesModal
          {...{ onClose: handleCloseModal, courseName: "Nuclear Energy" }}
        />
      ),
      description:
        "See the future of clean energy and the amazing atomic secrets unlocked with nuclear physics.",
      isFree: false,
      isPopular: false,
      icon: <GiNuclearPlant size={50} />,
      list: [
        "Basics of Nuclear Physics",
        "Further Concepts in Nuclear Physics",
        "Nuclear Fission",
        "Nuclear Fission Practice",
        "Nuclear Fusion",
        "Nuclear Fusion Practice",
        "Reactor Designs",
        "Reactor Designs Practice",
        "Advanced: Radiation and Safety",
        "Practice Questions",
        "Course Review",
      ],
      gif: "/static/home/nuclear_course.gif",
      longDescription:
        "Learn how we use nuclear energy to produce some of the cleanest energy we use and cutting edge research of nuclear fusion.",
    },
    "Local Networks": {
      component: (
        <CoursesModal
          {...{ onClose: handleCloseModal, courseName: "Local Networks" }}
        />
      ),
      description:
        "The intricacies of networking brought to a more realistic and fundamental view.",
      isFree: false,
      isPopular: false,
      icon: <LuNetwork size={50} />,
      list: [
        "Basics of Networking Protocols",
        "Further Networking Protocols",
        "Ethernet Technologies",
        "Ethernet Technologies Practice",
        "IP Addressing and Subnetting",
        "IP Addressing and Subnetting Practice",
        "Network Devices",
        "Network Devices Practice",
        "Advanced: VLANs",
      ...
      longDescription:
        "Form the basic understanding of current networking technologies used in local networks which allow computer systems to communicate in almost every business and institution.",
    },
  };
  const modalMapSoon = {
    "Special relativity": {
      description:
        "Learn to think like Einstein did with his miraculous theory of special relativity.",
      icon: <TbCone2 size={50} />,
    },
    Electricity: {
      description:
        "The modern development of humans that power everybodies lives.",
      icon: <GiCircuitry size={50} />,
    },
    "Waves and light": {
      description:
        "What exactly is light? These are the type of questions that physicists ask all the time.",
      icon: <GiSoundWaves size={50} />,
    },
    "Fundamental Calculus": {
      description:
        "Mathematical techniques from Newtonian times that advance our understanding of our universe.",
      icon: <TbMathIntegrals size={50} />,
    },
    "Graphing functions": {
      description:
        "Graphing made easier, patterns from numbers and functions used in engineering, computer science and more.",
            ...
            <div className={styles["content-wrapper"]}>
              ...
              <div className={styles["course-container"]}>
                    ...
                    <div key={i} className={styles["course-option-wrapper"]}>
                      <div className={styles["course-option-wrapper-main"]}>
                        <div className={styles["course-btn-icon-wrapper"]}>
                          <div>{modalMap[modalName].icon}</div>
                          <button
                        ...
                        <div
                          className={styles["course-mini-description-wrapper"]}
                        >
                          ...
                          >
                            ...
                            <span className={styles["show-more-text"]}>
                              Expand more
                            </span>
                          </div>
                        </div>
                      ...
                      {activeDropdown[modalName] && (
                        <div className={styles["expanded-description"]}>
                          <div
                            className={
                              styles["expanded-description-img-wrapper"]
                            }
                          >
                            <img
                              src={modalMap[modalName].gif}
                              alt="course-img"
                            ></img>
                          ...
                          <div className={styles["course-content"]}>
                            ...
                            <ol
                              className={styles["course-item-list"]}
                              type="number"
                            >
                ...
                <div>
                  <h1>Coming soon...</h1>
                  <p>
                    If you are signed up for premium, you will be notified via
                    email when new courses are available.
                  </p>
                </div>
                {Object.keys(modalMapSoon)
                  ...
                  .sort(
                    (a, b) =>
                      Number(modalMapSoon[b].isFree) -
                      Number(modalMapSoon[a].isFree)
                  )
                  .sort(
                    (a, b) =>
                  ...
                  .map((modalName, i) => (
                    <div
                      key={i}
                      className={`${styles["course-option-wrapper"]} ${styles["course-option-wrapper-coming-soon"]}`}
                    >
                      <div className={styles["course-option-wrapper-main"]}>
                        <div className={styles["course-btn-icon-wrapper"]}>
                          <div>{modalMapSoon[modalName].icon}</div>
                          <button
                            className={`${styles["open-course-btn"]} 
                                  ${
