        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}> 
                    ...
                    <img alt=''src="/static/physics/balancing-nuclear-equations/image009.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/balancing-nuclear-equations/image010.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/balancing-nuclear-equations/image011.png" className={styles['equation']}></img>
                    <p>Alpha decay equation example of uranium-238:</p>
                    <img alt=''src="/static/physics/balancing-nuclear-equations/image012.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/balancing-nuclear-equations/image013.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/balancing-nuclear-equations/image014.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/balancing-nuclear-equations/image015.png" className={styles['equation']}></img>
