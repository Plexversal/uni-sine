        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img alt=''src="/static/physics/gravitation-fields/image048.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image049.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitation-fields/image050.png" className={styles['equation']}></img>
                    <p>Where g can be calculated using:</p>
                    <img alt=''src="/static/physics/gravitation-fields/image051.png" className={styles['equation']}></img>
                    ...
                    <p>G = 6.67 x 10<sub>&shy;</sub>&shy;<sup>-11</sup> Nm<sup>2</sup>kg<sup>-2</sup></p>
                    <img alt=''src="/static/physics/gravitation-fields/image051.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image052.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image053.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitation-fields/image050.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image054.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image055.png" className={styles['equation']}></img>
                    ...
                    <p>G = 6.67 x 10<sub>&shy;</sub>&shy;<sup>-11</sup> Nm<sup>2</sup>kg<sup>-2</sup></p>
                    <img alt=''src="/static/physics/gravitation-fields/image051.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image056.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image057.png" className={styles['equation']}></img>
                    <p>Taking the same mass we used for average human:</p>
                    <img alt=''src="/static/physics/gravitation-fields/image050.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image058.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitation-fields/image059.png" className={styles['equation']}></img>
