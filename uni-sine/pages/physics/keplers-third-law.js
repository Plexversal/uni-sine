        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img alt=''src="/static/physics/keplers-third-law/image082.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitation-fields/image047.png" className={styles['equation']}></img>
                    <p>For an object moving in circular motion, the force is given by:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image083.png" className={styles['equation']}></img>
                    <p>Which means that this force is also equal to the gravitational force for an object orbiting in a circle.</p>
                    <img alt=''src="/static/physics/keplers-third-law/image084.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/keplers-third-law/image085.png" className={styles['equation']}></img>
                    <p>So, if we enter this into the force equation we get:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image086.png" className={styles['equation']}></img>
                    <p>We can now simplify:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image087.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image088.png" className={styles['equation']}></img>
                    <p>Solve for T squared:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image089.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/keplers-third-law/image089.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image090.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image091.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image092.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/keplers-third-law/image093.png" className={styles['equation']}></img>
                    <p>Solve for v:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image094.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image095.png" className={styles['equation']}></img>
                    <p>So, using this, let&rsquo;s work out the average orbital velocity of Jupiter using its average distance from the sun:</p>
                    <p>M<sub>1 </sub>= 1.989 x 10<sup>30 </sup>kg</p>
                    <p>r = 7.78358 x 10<sup>11</sup> m</p>
                    <p>G = 6.67408 x 10<sup>-11</sup> m<sup>3 </sup>kg<sup>-1 </sup>s<sup>-2</sup></p>
                    <img alt=''src="/static/physics/keplers-third-law/image095.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image096.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image097.png" className={styles['equation']}></img>
                    <p>So, the estimated orbital velocity of Jupiter is:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image098.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/keplers-third-law/image099.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/keplers-third-law/image099.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image100.png" className={styles['equation']}></img>
                    <p>Rearrange for T:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image101.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/keplers-third-law/image102.png" className={styles['equation']}></img>
                    <p>Solve for final number in days:</p>
                    <img alt=''src="/static/physics/keplers-third-law/image103.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/keplers-third-law/image104.png" className={styles['equation']}></img>
