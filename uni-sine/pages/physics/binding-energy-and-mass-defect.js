        ...
        <>
            ...
            <article id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}> 
                    ...
                    <img src="/static/physics/binding-energy/image016.png" className={styles['equation']}></img>
                    <img src="/static/physics/binding-energy/image017.png" className={styles['equation']}></img>
                    <img src="/static/physics/binding-energy/image018.png" className={styles['equation']}></img>
                    <img src="/static/physics/binding-energy/image019.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/binding-energy/image020.png" className={styles['equation']}></img>
                    <img src="/static/physics/binding-energy/image021.png" className={styles['equation']}></img>
                    <p>Now you can move on to calculating binding energy of an alpha particle in MeV:</p>
                    <img src="/static/physics/binding-energy/image022.png" className={styles['equation']}></img>
                    <img src="/static/physics/binding-energy/image023.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/binding-energy/image024.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/binding-energy/image025.png" className={styles['equation']}></img>
                    <p>Now you have the mass defect value in kg, you can work out binding energy using E = mc<sup>2</sup>:</p>
                    <img src="/static/physics/binding-energy/image026.png" className={styles['equation']}></img>
                    <p>You can convert back into MeV by using:</p>
                    <img src="/static/physics/binding-energy/image027.png" className={styles['equation']}></img>
                    <img src="/static/physics/binding-energy/image028.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/binding-energy/image029.png" className={styles['equation']}></img>
                    <p>So, if we use this formula to calculate the average binding energy per nucleon for the alpha particle:</p>
                    <img src="/static/physics/binding-energy/image030.png" className={styles['equation']}></img>
