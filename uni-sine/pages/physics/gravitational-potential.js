        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image060.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image061.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image062.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image063.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image064.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitational-potential/image065.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/gravitational-potential/image066.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image067.png" className={styles['equation']}></img>
                    <p>So potential energy of moon in relation to earth:</p>
                    <img alt=''src="/static/physics/gravitational-potential/image068.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image069.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/gravitational-potential/image070.png" className={styles['equation']}></img>
                    <p>Work done is also equal to mass times the potential difference:</p>
                    <img alt=''src="/static/physics/gravitational-potential/image071.png" className={styles['equation']}></img>
