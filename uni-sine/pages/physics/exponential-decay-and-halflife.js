        ...
        <>
            ...
            <article id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}> 
                    ...
                    <img src="/static/physics/half-life/image031.png" className={styles['equation']}></img>
                    <p>Written as:</p>
                    <img src="/static/physics/half-life/image032.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/half-life/image033.png" className={styles['equation']}></img>
                    <p>Written as:</p>
                    <img src="/static/physics/half-life/image034.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/half-life/image035.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/half-life/image036.png" className={styles['equation']}></img>
                    <img src="/static/physics/half-life/image037.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/half-life/image038.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/half-life/image039.png" className={styles['equation']}></img>
                    <p>Substituting the values, we get:</p>
                    <img src="/static/physics/half-life/image040.png" className={styles['equation']}></img>
                    <p>Using the equation for solving the number of unstable nuclei remaining, we can rearrange to solve for t (time):</p>
                    <img src="/static/physics/half-life/image041.png" className={styles['equation']}></img>
                    <p>Substituting the values, we get:</p>
                    <img src="/static/physics/half-life/image042.png" className={styles['equation']}></img>
                    <p>Rearrange the equation to solve for t:</p>
                    <img src="/static/physics/half-life/image043.png" className={styles['equation']}></img>
                    <img src="/static/physics/half-life/image044.png" className={styles['equation']}></img>
                    <img src="/static/physics/half-life/image045.png" className={styles['equation']}></img>
                    <p>After rearranging and solving we get the time in years:</p>
                    <img src="/static/physics/half-life/image046.png" className={styles['equation']}></img>
