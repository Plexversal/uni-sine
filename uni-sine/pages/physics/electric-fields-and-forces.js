        ...
        <>
            ...
            <article id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}>
                    ...
                    <p>Coulombs law:</p>
                    <img src="/static/physics/electric-fields/image001.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image002.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image003.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image004.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image005.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image006.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image007.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image008.png" className={styles['equation']}></img>
                    <p>This is also equal to the electric potential energy and is denoted by U and distance is usually referenced as r:</p>
                    <img src="/static/physics/electric-fields/image009.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image010.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image011.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image012.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image013.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image014.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image015.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image016.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image017.png" className={styles['equation']}></img>

                    <p>This can also be converted into MeV:</p>
                    <img src="/static/physics/electric-fields/image018.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image019.png" className={styles['equation']}></img>
                    <ol type="a" start={2}>
                    ...
                    <img src="/static/physics/electric-fields/image020.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image021.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image022.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image023.png" className={styles['equation']}></img>
                    ...
                    <img src="/static/physics/electric-fields/image024.png" className={styles['equation']}></img>
                    <p>So now we can solve for r, which is the closest distance the particles get to each other:</p>
                    <img src="/static/physics/electric-fields/image025.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image026.png" className={styles['equation']}></img>
                    <ol type="a" start={3}>
                    ...
                    <img src="/static/physics/electric-fields/image001.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image027.png" className={styles['equation']}></img>
                    <img src="/static/physics/electric-fields/image028.png" className={styles['equation']}></img>
