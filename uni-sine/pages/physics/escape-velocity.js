        ...
        <>
            ...
            <article itemScope itemType="http://schema.org/Article" id='article' className={styles['page-wrapper']}>
                <div className={styles['article-container']}> 
                    ...
                    <img alt=''src="/static/physics/escape-velocity/image072.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/escape-velocity/image073.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/escape-velocity/image074.png" className={styles['equation']}></img>
                    <img alt=''src="/static/physics/escape-velocity/image075.png" className={styles['equation']}></img>
                    ...
                    <img alt=''src="/static/physics/escape-velocity/image078.png" className={styles['equation']}></img>
                    <p>Complete the rest of the equation cancelling units when needed:</p>
                    <img alt=''src="/static/physics/escape-velocity/image079.png" className={styles['equation']}></img>
                    <p>Escape velocity from the surface of the earth:</p>
                    <img alt=''src="/static/physics/escape-velocity/image080.png" className={styles['equation']}></img>
                    <p>You can now divide that by 1000 to get units in km for easier understanding:</p>
                    <img alt=''src="/static/physics/escape-velocity/image081.png" className={styles['equation']}></img>
